...
function CarritoTotal() {
  ...
  carrito.forEach((item) => {
    ...
    const setBadge = document.querySelector('.badge')
    setBadge.innerHTML = item.cantidad
  });
...
function getData() {
  fetch("https://www.omdbapi.com/?i=tt3896198&apikey=372bc176")
    ...
    .then(() => {
      let title = dataApi[0].title;
      let img = dataApi[0].img;
      let description = dataApi[0].actors;
